...
const AdminCustomer = () => {
  ...
  const filteredData = data.filter((d) => {
    ...
    return (
      (nameSearch.trim() === ""
        ? true
        : d.name_index.toLowerCase().includes(nameSearch.toLowerCase())) &&
      (emailSearch.trim() === ""
        ? true
        : d.email.toLowerCase().includes(emailSearch.toLowerCase())) &&
  ...
  return (
    <div className="p-4">
      ...
      {showModal && (
        <CustomerModal customerId={customerId} onClose={handleModalClose} />
      )}
